			...
			{aboutHeroContent.contextual && (
				...
				>
					<div className='text-right'>
						{aboutHeroContent.contextual.label && (
							<p className='text-xs text-gray-500 mb-1 font-urbanist'>{aboutHeroContent.contextual.label}</p>
						)}
			...
			<div className='relative z-10 max-w-4xl mx-auto px-6 md:px-12 lg:px-16 text-center'>
				...
				>
					...
					<h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-black mb-6 md:mb-8 leading-tight font-blatant'>
						...
						<span className='text-[#10367D]'>{aboutHeroContent.headingHighlight}</span>
					</h1>

					{/* TIER 3 - Subheading */}
					<h2 className='text-xl md:text-2xl lg:text-3xl font-bold text-black mb-8 md:mb-10 leading-snug font-blatant'>
						Your Partner in <span className='text-[#74B4D9]'>Digital Transformation</span>
					</h2>

			...
			>
				...
				>
					<motion.img
						...
						alt={`${project.title} - ${
							project.tagline
						} | ${project.category.join(', ')} project by ProCraft Dubai`}
...
export default function Portfolio() {
	// Display only 6 featured projects
	const projects = caseStudies.filter((study) => study.featured).slice(0, 6);
					...
					<div className='flex flex-col gap-8'>
						...
						<motion.div variants={container}>
							...
							<p className='mt-5 max-w-md text-base leading-6 text-gray-400'>
								Whether we&apos;re building a new website, creating new
								branding, composing compelling copy or increasing a
								business&apos; social media presence; you can always count on{' '}
								<span className='font-semibold'>procraft</span>. Our skilled and
								dedicated team are meticulous in the implementation of various
								marketing strategies. Together, we are forever working hard
								towards achieving our clients&apos; vision.
							</p>
							<a
								href='/work'

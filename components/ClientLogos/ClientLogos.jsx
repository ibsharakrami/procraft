...
export default function ClientLogos() {
  ...
  // Offset the second row by half the array length
  const half = Math.floor(clientLogos.length / 2);
  const offsetLogos = [...clientLogos.slice(half), ...clientLogos.slice(0, half)];
    ...
    <section data-theme="light" className="bg-white py-16 md:py-20 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 md:px-[96px]">
        ...
        <ScrollVelocityContainer className="w-full">
          ...
          >
            <ScrollVelocityRow baseVelocity={0.7} direction={1} className="py-4 md:py-6" isHovered={isHovered}>

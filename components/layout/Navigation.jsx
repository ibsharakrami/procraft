...
export default function Navigation() {
	...
	return (
		<>
			...
			<div
				className={`fixed left-1/2 -translate-x-1/2 md:left-[56px] md:translate-x-0 top-[40px] md:top-[60px] z-50 pointer-events-none transition-opacity duration-500 ${
			...
			<div
				className={`fixed left-1/2 -translate-x-1/2 md:left-[56px] md:translate-x-0 bottom-[40px] md:bottom-[50px] z-50 pointer-events-none transition-opacity duration-500 ${
					isMenuOpen ? 'opacity-0' : 'opacity-100'
				}`}
			>
			...
			<div
				className={`fixed left-1/2 -translate-x-1/2 md:left-[44px] md:translate-x-0 top-[50%] -translate-y-1/2 z-50 transition-opacity duration-500 ${

					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 mb-12'>
						...
						<div className='lg:col-span-2'>
							...
							<p className='text-gray-400 leading-relaxed mb-6 max-w-md'>
								Crafting Growth Through Strategy & Design. We turn business
								ideas into digital success stories — combining smart consulting,
								creative design, and cutting-edge technology to help brands
								grow.
							</p>
							{/* Social Links */}

...
export const metadata = {
	...
	description:
		'Award-winning creative digital agency in Dubai specializing in business consulting, web design, e-commerce, digital marketing, SEO, and branding. Transform your business with strategic growth solutions in Deira, Dubai, UAE.',
	keywords: [
	...
	openGraph: {
		...
		description:
			"Transform your business with strategic consulting, creative design, and cutting-edge technology from Dubai's leading digital growth agency.",
	...
	twitter: {
		...
		title: 'ProCraft - Creative Digital Growth Agency in Dubai',
		description:
			'Transform your business with strategic consulting, creative design, and cutting-edge technology.',
...
export default function RootLayout({ children }) {
	...
	const organizationSchema = {
		...
		description:
			'Creative digital growth agency in Dubai specializing in business consulting, web design, e-commerce, digital marketing, and branding solutions.',
		url: 'https://procraft.ae',
		logo: 'https://procraft.ae/images/NewLogo_procraft.png',
		image: 'https://procraft.ae/images/NewLogo_procraft.png',
			...
			itemListElement: [
				{
					...
					itemOffered: {
						...
						description:
							'Strategic business consulting, retention strategy, startup guidance, and investment advisory.',
					},
				},
				{
					'@type': 'Offer',
					itemOffered: {
						...
						description:
							'Custom website design and development services with responsive, SEO-friendly solutions.',
					},
				},
				{
					'@type': 'Offer',
				...
				},
				{
					...
					itemOffered: {
						...
						description:
							'Keyword optimization, ad campaigns, and visibility strategies for online growth.',
					},
				},
				{
					'@type': 'Offer',
					itemOffered: {
						...
						description:
							'Audience growth and engagement strategies for Instagram, Facebook, and LinkedIn.',
					},
				},
				{
					'@type': 'Offer',
					itemOffered: {
						...
						name: 'Graphic Design',
						description:
							'Logo design, branding kits, and comprehensive visual identity systems.',
					},
				},
			],
		},

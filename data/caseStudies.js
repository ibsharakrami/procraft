export const caseStudies = [
  {
    ...
    galleryImages: [
      {
        ...
        caption: "Homepage hero section showcasing premium interior design portfolio"
      },
      {
        url: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=1600&q=80",
        caption: "Services section with detailed offerings and consultation CTA"
      },
      {
      ...
      },
      {
        ...
        caption: "Multi-language switcher supporting English, Hindi, and Kannada"
      },
      {
    ...
    outcomes: [
      {
        ...
        description: "The new website achieved a 90+ PageSpeed score, resulting in faster load times and improved user engagement. The consultation booking system streamlined client acquisition, with 150+ successful bookings in the first three months post-launch."
      },
      {
        title: "Multi-Language Accessibility",
        description: "The implementation of three-language support (English, Hindi, Kannada) expanded Sharma Space's reach across diverse demographics in Bangalore. This accessibility feature contributed to a 35% increase in consultation requests from non-English speaking clients."
      },
      {
        title: "SEO & Organic Growth",
        description: "Schema markup and SEO optimization led to improved search rankings for key terms like 'interior design Bangalore' and 'modular kitchen Koramangala.' Organic traffic increased by 60% within six months, reducing dependence on paid advertising."
      }
    ],

    // Client testimonial
    testimonial: {
      quote: "ProCraft transformed our digital presence beyond our expectations. The website perfectly captures the sophistication of our interior design work, and the booking system has streamlined our client acquisition process. We've seen a significant increase in high-quality leads since launch.",
    ...
    beforeAfter: {
      before: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=800&q=80",
      after: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80",
      description: "Transformation from a basic template website to a premium, custom-designed platform that reflects Sharma Space's high-end positioning in the Bangalore interior design market."
    },
...

  {
    ...
    processSteps: [
      {
        ...
        description: "We conducted extensive research into Riyadh's entertainment landscape and the emerging golf simulator market in Saudi Arabia. Understanding the unique blend of serious golfers and social entertainment seekers, we developed a dual-focus strategy. We analyzed competitors across the GCC region and identified opportunities to differentiate The Virtual Greens through superior digital experience and community engagement features.",
        image: "https://images.unsplash.com/photo-1530028828-25e8270e4b7f?w=1200&q=80"
      },
      {
        title: "Brand & Visual Design",
        description: "Our design approach balanced sophistication with approachability. We created a visual identity that showcases the venue's premium golf simulation technology while emphasizing the social, entertaining aspects. The color palette combines classic golf greens with modern, vibrant accents suitable for the Middle Eastern market. We designed an intuitive booking interface that works seamlessly in both Arabic and English.",
      ...
      },
      {
        ...
        description: "We orchestrated a phased launch strategy, beginning with a soft opening to VIP members and golf enthusiasts, followed by a broader public launch tied to social media campaigns. We established automated social media posting systems and community management tools to drive engagement. Post-launch optimization focused on conversion rate improvement for bookings and social sharing features to amplify word-of-mouth marketing.",
    ...
    galleryImages: [
      ...
      },
      {
        ...
        caption: "Interactive venue showcase with 360° virtual tour integration"
      },
      {
      ...
      },
      {
        ...
        caption: "Event management system for tournaments and corporate bookings"
      }
    ],
    ...
    outcomes: [
      {
        ...
        description: "The Virtual Greens quickly established itself as Riyadh's premier golf entertainment destination. The website's intuitive booking system and social features contributed to rapid customer acquisition, with the venue reaching 80% capacity utilization within three months of launch."
      },
      {
        title: "Social Media Amplification",
        description: "Deep social media integration resulted in significant viral growth. User-generated content sharing features led to a 200% increase in organic social media reach. The community wall feature displaying Instagram posts created a feedback loop that encouraged more visitors to share their experiences."
      },
      {
        title: "Enterprise Performance",
        description: "Singapore-based hosting infrastructure delivered sub-2-second load times across the Middle East region. The platform successfully handled peak traffic during launch events and weekend rushes without performance degradation, ensuring smooth booking experiences even during high-demand periods."
      }
    ],

    testimonial: {
      quote: "ProCraft delivered a digital platform that perfectly captures the energy and sophistication of our venue. The seamless booking system and social integration have been game-changers for our business. We've seen tremendous growth in both golf enthusiasts and social groups discovering us online.",
    ...
    beforeAfter: {
      before: "https://images.unsplash.com/photo-1454923634634-bd1614719a7b?w=800&q=80",
      after: "https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=800&q=80",
      description: "Evolution from a basic informational website to a fully integrated entertainment platform with booking, social features, and community engagement tools."
    },
...

  {
    ...
    galleryImages: [
      {
        ...
        caption: "Homepage showcasing featured handcrafted furniture collections"
      },
      {
        url: "https://images.unsplash.com/photo-1613575831056-0acd111736cf?w=1600&q=80",
        caption: "Product detail page with zoom functionality and wood grain close-ups"
      },
      {
        url: "https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?w=1600&q=80",
        caption: "Custom order form with real-time pricing and 3D visualization"
      },
      {
        url: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?w=1600&q=80",
        caption: "Behind-the-scenes craftsmanship gallery showing production process"
      },
      {
        url: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&q=80",
        caption: "Shopping cart with flexible payment options for high-value orders"
      },
      {
    ...
    beforeAfter: {
      ...
      description: "Transformation from a basic product catalog to a sophisticated e-commerce platform that conveys luxury craftsmanship and enables seamless bespoke ordering."
    },
